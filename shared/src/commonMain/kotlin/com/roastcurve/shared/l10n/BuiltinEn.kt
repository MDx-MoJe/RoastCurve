...
object BuiltinEn {
    val strings: Map<String, String> by lazy {
        buildMap {
            ...
            put("manual.s70", "8. Language Packs")
            put("manual.s71", "Settings → Language switches built-in 中文/English, or imports a language pack zip (small ~1 KB file). Tap Apply, then restart the app to take effect.")
            put("manual.s72", "Community packs are on GitHub Releases; translate your own following the format. Missing keys fall back to Chinese - partial translations are fine.")
